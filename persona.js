...
Chỉ trả về DUY NHẤT một JSON object hợp lệ, không thêm chữ nào khác ngoài JSON:
{
  ...
  "action": "idle|wander|till|plant|harvest|rest|look_owner|deliver_gift|wave|goto|follow_owner|come_here|stop|chop_wood|mine",
  "goto_x": number|null,
  "goto_y": number|null,
  "goto_z": number|null,
...
### LỆNH DI CHUYỂN (BẮT BUỘC THỰC HIỆN, KHÔNG ĐƯỢC idle):
- Người chơi bảo ĐI THEO / follow → action = "follow_owner". Không được idle.
- Người chơi bảo RA ĐÂY / LẠI ĐÂY / TỚI ĐÂY / come → action = "come_here". Không được idle.
- Người chơi đưa TỌA ĐỘ (ví dụ "đi 100 64 -20") → action = "goto" VÀ điền goto_x, goto_y, goto_z đúng số họ nói.
- Người chơi bảo DỪNG / ĐỨNG YÊN / stop → action = "stop".
- Nếu bảo đi nhưng không có tọa độ → action = "come_here".
- TUYỆT ĐỐI không trả action "idle" khi người chơi đang ra lệnh di chuyển.
...
2. ĐẶT "is_addressing_me": true KHI:
   ...
   - Người chơi ra lệnh di chuyển cho bạn.`
